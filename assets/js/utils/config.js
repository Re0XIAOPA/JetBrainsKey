...
import { jetbrainsConfig } from './config/jetbrainsConfig.js';
import { pluginsConfig } from './config/plugins.js';
import { jetbrains2099Config } from './config/jetbrains2099Config.js';
    ...
    text: {
        zh: {
            ...
            downloadInfo: {
                ...
                jetbrains2099: "📥 2099版本为长期支持版本，无需密钥所以没有提供密钥，<a href='jetbraZip/files/JetBrains全家桶激活(2024最新激活2099).zip' download>点击下载</a>，并按说明进行配置！🚨 仅限测试目的，请勿用于商业用途！"
            },
        ...
        en: {
            ...
            downloadInfo: {
                ...
                jetbrains2099: "📥 2099 version is LTS, no key required so no key provided, <a href='jetbraZip/files/JetBrains-Activation-2099.zip' download>Download</a>, and configure as described in instructions! 🚨 For testing purposes only, not for commercial use!"
            },
